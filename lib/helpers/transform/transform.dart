...
class TransformHelper {
  static Transform rotate(
      {double? a, double? b, double? c, double? d, required Widget child}) {
    return Transform(
      transform: Matrix4(
  ...
  static Transform scale({double? x, double? y, double? z, required Widget child}) {
    return Transform(
      transform: Matrix4(
  ...
  static Transform translate({double? x, double? y, double? z, required Widget child}) {
    return Transform(
      transform: Matrix4(
